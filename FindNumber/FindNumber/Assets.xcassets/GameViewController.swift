...
//  FindNumber
//
//  Created by Левинская Оксана Юрьевна on 20.11.2021.
//
...
// MARK: - PROPERTIES
    ...
    private func showAlert(){
        let alerrt = UIAlertController(title: "Позддравляем!", message: "Вы установли новый рекорд!", preferredStyle: .alert)
        
        let okAction = UIAlertAction(title: "OK", style: .default, handler: nil)
        alerrt.addAction(okAction)
        
        present(alerrt, animated: true, completion: nil)
    }
